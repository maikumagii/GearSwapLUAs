...
function job_setup()
    ...
    init_job_states(
    { "Capacity", "AutoFoodMode", "AutoTrustMode", "AutoWSMode", "AutoJumpMode", "AutoShadowMode", "AutoStunMode",
        "AutoDefenseMode" },
        { "AutoBuffMode", "AutoSambaMode", "AutoRuneMode", "Weapons", "OffenseMode", "WeaponskillMode", "Stance",
